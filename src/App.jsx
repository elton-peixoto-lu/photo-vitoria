...
import { FaImages, FaBaby, FaHeart, FaVenus, FaCameraRetro, FaCamera, FaEnvelope, FaInstagram, FaHome } from 'react-icons/fa';
...
function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="bg-gradient-to-b from-[#f8fafc] via-[#fbeffb] to-[#fffbe9] text-gray-700 w-40 h-screen fixed left-0 top-0 flex flex-col px-2 py-4 shadow-2xl border-r border-[#f3e8ff] z-40"
    >
      <Logo />
  ...
  return (
    <BrowserRouter>
      <div className="flex min-h-screen">
        <Sidebar />
        <div className="flex-1 flex flex-col min-h-screen bg-gradient-to-b from-[#f8fafc] via-[#fbeffb] to-[#fffbe9] ml-40">
