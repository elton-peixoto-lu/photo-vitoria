...
<!-- template: login.ftl (photo-vitoria + Turnstile) -->
          ...
          <div id="kc-form-wrapper">
            <#if realm.password>
                <form id="kc-form-login" class="${properties.kcFormClass!}" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post" novalidate="novalidate">
                    ...
                    <#-- Cloudflare Turnstile (renderiza somente se o Authenticator setar o sitekey) -->
                    <#if turnstileSiteKey?? && turnstileSiteKey?has_content>
